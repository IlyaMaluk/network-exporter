...
export const NetworkRxChart = ({ selectedInterfaces = [] }: { selectedInterfaces?: string[] }) => {
  ...
  const { data, loading } = usePrometheus({
    query: `rate(node_network_receive_bytes_total${interfaceFilter}[5m])`,
